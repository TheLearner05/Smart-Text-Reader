#from text_translate import translate
...
class Text2Speech:
    ...
    def __init__(self):
        ...
        self.mytext = "Hello. Welcome to this journey of learning with Smart Text Reader!! Please select the preferred language"

    def Convert2Speech(self, mytext, lang):
        # print("12334565")
        #lang = list(LANGUAGES.keys())[list(LANGUAGES.values()).index(lang.lower())]
        #ftext = trans(mytext, lang)
        trans = Translator()
